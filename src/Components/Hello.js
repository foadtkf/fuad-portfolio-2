...
Ojieame <span style={{color:"blue"}}>.</span></h1>
      ...
      <div  className=''>
      <button class="btn btn-ghost  hover:outline hover:outline-teal-300">Scroll for more</button></div>
    </div>
    </Fade>
    <Zoom top>
    <img src="https://images.unsplash.com/photo-1503443207922-dff7d543fd0e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=327&q=80" class="shadow-2xl"  alt=''/></Zoom>
  </div>
</div>
...
Ojieame <span style={{color:"blue"}}>.</span></h1>
      <p class="py-6">An enthusiastic product designer currently shaping the future of software development by designing smooth user-interfaces that promote user interaction with information and data. While traveling around the world.</p>
      <div className=''>
      <a href='#skills'><button class="btn btn-ghost  hover:outline hover:outline-teal-300">Scroll for more</button></a></div>
    </div>
  </div>
</div>
        </div>
