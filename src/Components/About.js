...
const About = () => {
    return (
        <div class="hero min-h-screen " style={{backgroundImage:'url(https://cdn.dribbble.com/users/236204/screenshots/4650277/media/475b932e6b5fc0145524c916a9e2297c.gif)',}}>
...
<h1 class="text-xl font-bold text-blue-900">About me</h1>
      ...
      <a href='https://www.instagram.com/daddytkff/'><button class="btn btn-ghost  hover:outline hover:outline-teal-300">Follow me on instagram</button></a>
</div>
</Fade>
<Fade top cascade>
